...
public class AddonRemoveGrass : AddOnBehaviour
{
    ...
    public const string ADDON_NAME = "Remove Grass";
    public const string ADDON_AUTHOR = "R.Andrew";
    public const string ADDON_DESCRIPTION = "Allow to remove the grass when a part is placed, this require a lot performance according terrain size.";
