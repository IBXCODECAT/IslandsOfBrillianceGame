    ...
    public class BuildStorageInspector : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (BaseFoldout)
            {
                ...
                EditorGUILayout.PropertyField(serializedObject.FindProperty("LoadAndWaitEndFrame"), new GUIContent("Load And Wait End Of Frame :", 
                    "This allows to WaitEndOfFrame to instantiate the next part, useful to avoid the spikes at start of the scene (recommended: for headless server)."));
